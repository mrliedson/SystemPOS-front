  ...
  <div class="tela">
    ...
    <div class="tudo">
      ...
      <div class="logoEfiltros">
        ...
        <input class="text-input" type="text" :value="dadosPromocao.precoNovo" disabled />
...
const repor = async () => {
  console.log(dadosPromocao.id)
  try {
    await axios.put(`http://localhost:3333/produto/AP/${dadosPromocao.id}`, {
      preco: dadosPromocao.precoNovo,
    })
    router.push('/alterarPreco')
  } catch (error) {
    console.error('Erro ao adicionar promoção:', error)
    mensagem.value=`Erro ao adicionar promoção`
